...
# File: db_bmp180.tcl
# Generated on: Sat Aug 07 13:37:35 2021
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "top_bmp180"]} {
		puts "Project top_bmp180 is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists top_bmp180]} {
		project_open -revision top_bmp180 top_bmp180
	} else {
		project_new -revision top_bmp180 top_bmp180
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name TOP_LEVEL_ENTITY db_bmp180
	set_global_assignment -name ORIGINAL_QUARTUS_VERSION 18.1.0
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "13:16:00  AUGUST 07, 2021"
	...
	set_global_assignment -name VERILOG_FILE source/db_bmp180.v
	set_global_assignment -name VERILOG_FILE source/top_bmp180.v
	set_global_assignment -name VERILOG_FILE source/controller.v
	set_global_assignment -name VERILOG_FILE source/rom_instr.v
	set_global_assignment -name VERILOG_FILE source/opm.v
	set_global_assignment -name VERILOG_FILE source/calc.v
	set_global_assignment -name VERILOG_FILE source/alu.v
	set_global_assignment -name VERILOG_FILE source/mult.v
	set_global_assignment -name VERILOG_FILE source/div.v
	...
	set_global_assignment -name VERILOG_FILE source/clk_div_msrmnt.v
	set_global_assignment -name SDC_FILE source/db_bmp180.sdc
	set_global_assignment -name SDC_FILE source/top_bmp180.sdc
	set_global_assignment -name POWER_PRESET_COOLING_SOLUTION "23 MM HEAT SINK WITH 200 LFPM AIRFLOW"
	set_global_assignment -name POWER_BOARD_THERMAL_MODEL "NONE (CONSERVATIVE)"
	set_global_assignment -name TIMING_ANALYZER_MULTICORNER_ANALYSIS ON
	set_global_assignment -name NUM_PARALLEL_PROCESSORS ALL
	set_global_assignment -name EDA_TEST_BENCH_ENABLE_STATUS TEST_BENCH_MODE -section_id eda_simulation
	set_global_assignment -name EDA_NATIVELINK_SIMULATION_TEST_BENCH tb_bmp180 -section_id eda_simulation
	set_global_assignment -name EDA_TEST_BENCH_NAME tb_i2c_master -section_id eda_simulation
	set_global_assignment -name EDA_DESIGN_INSTANCE_NAME NA -section_id tb_i2c_master
	set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME tb_i2c_master -section_id tb_i2c_master
	set_global_assignment -name EDA_TEST_BENCH_NAME tb_div -section_id eda_simulation
	set_global_assignment -name EDA_DESIGN_INSTANCE_NAME NA -section_id tb_div
	set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME tb_div -section_id tb_div
	set_global_assignment -name EDA_TEST_BENCH_NAME tb_bmp180 -section_id eda_simulation
	set_global_assignment -name EDA_DESIGN_INSTANCE_NAME NA -section_id tb_bmp180
	set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME tb_bmp180 -section_id tb_bmp180
	set_global_assignment -name EDA_TEST_BENCH_FILE testbench/tb_i2c_master.v -section_id tb_i2c_master
	set_global_assignment -name EDA_TEST_BENCH_FILE testbench/tb_div.v -section_id tb_div
	set_global_assignment -name EDA_TEST_BENCH_FILE testbench/tb_bmp180.v -section_id tb_bmp180
